...
HD_PWD='E:/bert_102017/bert_102017.runs/design_1_led_ctl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_led_ctl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_led_ctl_0_0.tcl
