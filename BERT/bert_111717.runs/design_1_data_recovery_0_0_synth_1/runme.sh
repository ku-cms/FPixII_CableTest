...
HD_PWD='C:/SharedProjects/bert_111717 - Copy/bert_111717.runs/design_1_data_recovery_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_data_recovery_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_data_recovery_0_0.tcl
